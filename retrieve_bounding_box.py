...
class BoundingBoxWidget(object):
    ...
    def extract_coordinates(self, event, x, y, flags, parameters):
        ...
        # Record ending (x,y) coordintes on left mouse button release
            ...
            print("top={}, left={}, height={}, width={}".format(self.image_coordinates[0][1], self.image_coordinates[0][0], self.image_coordinates[1][0] - self.image_coordinates[0][0], self.image_coordinates[1][1] - self.image_coordinates[0][1]))
